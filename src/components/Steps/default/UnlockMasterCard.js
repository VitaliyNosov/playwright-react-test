...
*/
  ...
  return (
    <div className="custom-steps custom-steps-custom select-director select-director-custom">
      

      <div className="custom-master-cart-header">
        <p>Who will receive an</p>
        <span className="custom-mastercard-r-v2">Unlock Mastercard</span>
      </div>


      <div className="search-results search-results-custom">
                ...
                <>
                  <div className="director-name-block">
                    ...
                    <div className="name">
                      ...
                      <div className='input-block input-block-mobile-custom'>
...
*/}
      ...
      <div className='unlock-master-card-button'>
      <StepButtons
