...
const DirectorsList = ({ handleGotoNext, validateEmail }) => {
  ...
  return (
    <div className="custom-steps director-list-two">
      
    <div className='custom-directors-header'>
        <p>Nominate the Director</p>
      ...
      <div className="bottom-section">
        ...
        <button onClick={handleSubmit} disabled={ids.length == 0} className="primary-btn primary-btn-custom-two">
          Submit
        </button>
      </div>
    </div>
