...
const BankAccountDetails = ({ handleGotoPrev, handleGotoNext, validateEmail, renderLabel }) => {
  ...
  return (
    <>
      <div className='custom-bank-account'>

      <div className='bank-info-form'>
        <span>Which bank account to pay when due?</span>
      </div>

      <div className={'col-2-list all-payments-unlock-block all-payments-unlock-block-custom'}>
        {/* <h3 className="text">
        ...
        <div className={`form-group ${dataError['name'] ? 'error' : ''}`}>
          <div className="form-field form-field-bank-custom">
        ...
        <div className={`form-group account-number-group ${dataError['account_number'] ? 'error' : ''}`}>
          <div className="form-field form-field-bank-custom">
            ...
            <input
              ...
              placeholder="Input your Account No"
            />
          </div>
      ...
      <div className="custom-steps form-field-bank-custom">
