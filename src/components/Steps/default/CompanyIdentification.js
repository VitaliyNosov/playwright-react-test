...
import iconProfile from '../../../assets/images/icons/icon-search.svg';
...
const CompanyIdentification = ({ handleGotoPrev, handleGotoNext }) => {
  ...
  return (
    <div className="custom-steps company-identification">
      ...
      <div className='block-position-center block-position-center-two'>
      ...
      <div className="search-group">
        <div className='input-block'>
         ...
         <div className="icon-input-image icon-input-image-two">
      ...
      {searchCounter > 0 ? (
        <div className="search-results">
          ...
          {results.length > 0 ? (
            ...
            <p>'We could not find any companies that match the search values. Please try another search.'</p>
          )}
        </div>
      ) : (
        ''
