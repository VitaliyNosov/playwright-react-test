...
import iconBage from '../../../assets/images/icons/icon-bage.svg';
...
{/* 
        ...
        <div className={`form-group ${dataError['mobileNumber'] ? 'error' : ''}`}>
          ...
          <div className='test-nob-block'>
            <div><span>Phone Verification</span></div>
            <div><p>Enter your mobile phone number below.</p></div>
            <div><p>You will receive a code to confirm your identity.</p></div>
          </div>
        ...
        <div className={`form-group`}>
          <div className="form-field custom-form-field-text">
            <br/>
            A message with the verification code has been sent to your mobile number. 
        ...
        <div className={`form-group ${dataError['lastName'] ? 'error' : ''}`}>
          <div className="form-field">
            ...
            <div className="icon-input-image">
              <img src={iconBage} alt="icon-image"/>
            </div>
