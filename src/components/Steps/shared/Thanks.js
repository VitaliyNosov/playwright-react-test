...
// import desktopHero from '../../../assets/images/landing_desktop-2.png';
  ...
  return (
    <Layout title={isReferred ? 'You are referred' : 'Thanks'}>
      <div className="form-layout">
        <MobileView className="hero-image custom-hero-image">
          <img src={mobileHero} alt="Hero image" />
        </MobileView>
        <BrowserView className="hero-image custom-hero-image">
          <img src={desktopHero} alt="Hero image" />
        </BrowserView>
        <p className="font-bold max-w-[75%] text-center text-base custom-color-v2">
      ...
      <div>
        <div className="d-flex bottom-actions align-center">
          <div className="d-flex">
            <button className="primary-btn home-btn custom-button-color-v2 custom-button-position-v2" onClick={handleClick}>
              Done
            </button>
          </div>
        </div>
